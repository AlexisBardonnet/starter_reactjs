...
## II - Apps
### Back-End
- [Name of git repository] ([Link of git repository])
...
Deploy the app to prod environment. You need to build the app with `npm run build` to edit the changes.
